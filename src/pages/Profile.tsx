...
const Profile = () => {
  ...
  useEffect(() => {
    try {
      ...
      // If no views stored, start with 5688
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start pt-12 relative overflow-hidden bg-gradient-to-br from-[#1A1F2C] via-[#6E59A5] to-[#9b87f5]">
      ...
      <div className="flex flex-col gap-4 w-full max-w-md px-4 z-10">
        <SocialLink href="https://instagram.com/tsx.duxs">
        ...
        <SocialLink href="https://discord.gg/vKYK4Zxp" className="!bg-[#5865F2]/20 hover:!bg-[#5865F2]/40">
          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
        ...
        <SocialLink href="https://open.spotify.com/user/31jau7m672eiyksjzvall2knoh3m?si=ReQEAMA0Q3Shk51NYpnQWw" className="!bg-[#1DB954]/20 hover:!bg-[#1DB954]/40">
