  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start pt-12 bg-black text-white relative overflow-hidden">
      ...
      <div className="flex flex-col gap-4 w-full max-w-md px-4">
        ...
        <SocialLink href="https://tiktok.com/@inevitavelrs">
        ...
        <SocialLink href="https://discord.gg/inevitavelrs" className="!bg-[#5865F2]/20 hover:!bg-[#5865F2]/40">
          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
        ...
        <SocialLink href="https://open.spotify.com/user/inevitavelrs" className="!bg-[#1DB954]/20 hover:!bg-[#1DB954]/40">
