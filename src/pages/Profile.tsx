...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-black via-purple-900 to-purple-600">
      ...
      {/* Social Links */}
      <div className="flex gap-4 w-full max-w-md px-4 z-10 justify-center">
        ...
        <SocialLink href="https://open.spotify.com/user/31jau7m672eiyksjzvall2knoh3m?si=ReQEAMA0Q3Shk51NYpnQWw" className="!px-3 !bg-[#1DB954]/20 hover:!bg-[#1DB954]/40">
          <svg viewBox="0 0 168 168" className="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
             <path d="M84 0a84 84 0 100 168 84 84 0 000-168zm38.25 121.56a6.3 6.3 0 01-8.62 2.34c-23.62-14.38-53.32-17.62-88.53-9.54a6.3 6.3 0 11-2.91-12.28c37.17-8.81 69.79-5.06 96.55 10.44a6.3 6.3 0 012.51 8.54zm11.25-21.09a7.87 7.87 0 01-10.82 2.9c-26.91-16.47-67.97-21.27-99.27-11.52a7.87 7.87 0 11-4.98-15.06c34.92-11.55 80.36-6.18 111.88 13.03a7.87 7.87 0 012.89 10.65zm1.83-23.42c-30.33-18.57-80.27-20.33-109.01-11.03a9.44 9.44 0 01-6-17.92c33.53-11.19 87.38-9.11 122.53 13.1a9.44 9.44 0 11-9.48 16.37z" />
          </svg>
        </SocialLink>
      </div>
